    ...
    info:[
        {
            projects: {
                ...
                titles : ["Reserva de Asientos", "Whatsapp", "Invitados", "Registro para elegir una bicicleta", "me primer portfolio", "Hacker api", "modo movil lyft", "Scoreboard", "Rounter" ],
                description : ["Reservar asientos, nunca había sido más sencillo (model)", "Mensajes con tus amigos", "Checklist para los invitados de una boda", "Elige un tipo de bicicleta, muy necesarios!", "Conóceme un poco", "Encuentra por nombre de author", "Pide un taxi y el modelo para que puedan recogerte, aplicación", "Controla y agrega a jugadores en sus partidas", "Platarforma más completa"]
            }
